...
public class JuryDetailsAdapter extends
        RecyclerView.Adapter<JuryDetailsAdapter.ProjectsViewHolder> {

    private JuryDetailsActivity activity;
    private List<Projects> projectsList;
    private List<Integer> positionsExpanded;

    public JuryDetailsAdapter(JuryDetailsActivity juryDetailsActivity) {
